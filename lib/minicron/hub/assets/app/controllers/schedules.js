    ...
    actions: {
      save: function(data) {
        ...
        if (data.schedule.get('formatted').substr(0, 1) === '@') {
          data.schedule.set('minute', null);
          data.schedule.set('hour', null);
          data.schedule.set('day_of_the_month', null);
          data.schedule.set('month', null);
          data.schedule.set('day_of_the_week', null);
        }
